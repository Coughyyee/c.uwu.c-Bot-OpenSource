...
module.exports = {
    ...
    async run (bot, message, args) {
        ...
        message.channel.send(`**${message.author.username}**, I've added the **${rname}** role to **${message.mentions.users.first().username}**.`).then(message => {
